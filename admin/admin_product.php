...
class Foto_upload extends file_upload {
	...
	function img_rotate($wr_file, $comp) {
		...
		if ($this->use_image_magick) {
			...
			$src_img = imagecreatefromgif($wr_file);
			...
			imagegif($new_img, $this->upload_dir.$this->file_copy, $comp);
		}
	}
...
$max_size = 2048*2048; // the max. size for uploading (~1MB)
...
$foto_upload->foto_folder = $_SERVER['DOCUMENT_ROOT'].$foldername."/images/product/photo/";
$foto_upload->thumb_folder = $_SERVER['DOCUMENT_ROOT'].$foldername."/images/product/thumb/";
$foto_upload->extensions = array(".gif"); // specify the allowed extension(s) here
...
if (isset($_POST['Submit']) && $_POST['Submit'] == "Upload") {
	...
	echo "insert into `data_product` set `category`='$productcategory',`name`='$productname',`brand`='$productevent',`event`='-',`show`='$productshow',`desc`='$productdesc',`url`='".$foto_upload->the_file."'";
	mysqli_query($mysqli1,"insert into `data_product` set `category`='$productcategory',`name`='$productname',`brand`='$productevent',`event`='-',`show`='$productshow',`desc`='$productdesc',`url`='".$foto_upload->the_file."'");
	echo"<table align=center width=500 style=background-color:gray;><tr style=background-color:lightgreen;font-family:arial;font-size:16px;font-weight:bold;><td>Confirmation</td></tr><tr style=font-family:verdana;color:white;font-weight:bold;><td>Success Inserted New Product&nbsp;<a href=admin_product.php style=color:blue;>BACK </a></td></tr><table>";
die();
	}
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
echo"<tr bgcolor=lightgreen><td colspan=2 style=font-family:verdana;font-size:15px;text-align:center;font-weight:bold;>Add New Product</td></tr>";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
echo"<tr>
<td style=font-family:arial;font-weight:bold;color:white; width=200>Category</td>
<td width=300><select style=width:300px; id=productcategory name=productcategory><option value='$productcategory'>$productcategory";
$TAKEdata_category=mysqli_query($mysqli1,"select * from `data_category` where `name`!='$productcategory' order by `name` asc");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
echo"<tr><td style=font-family:arial;font-weight:bold;color:white; width=200>Event</td><td width=300><select name=productevent><option value=0>Our Products<option value=1>Our Activities</select></td></tr>";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
echo"<tr><td style=font-family:arial;font-weight:bold;color:white; width=200>Show in Homepage</td><td width=300><select name=productshow><option value=1>Yes<option value=0>No</select></td></tr>";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
echo"<tr style=font-family:helvetica;font-size:14px;font-weight:bold;color:white;><td colspan=2>Click <a href=admin_viewproduct.php style=color:red;text-decoration:none;font-family:verdana;>here</a> to view product</td></tr>";
echo"</table>	</form>";
echo"</body>";
?>