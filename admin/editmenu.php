...
$menuid=$_GET[menuid];
$desc=mysqli_result1(mysqli_query($mysqli1,"select `desc` from `menu` where `id`='$menuid'"),0);
$name=mysqli_result1(mysqli_query($mysqli1,"select `name` from `menu` where `id`='$menuid'"),0);
?>
