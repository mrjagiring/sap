...
function displaysubcategory(){
	...
	window.location='admin_news.php?productcategory='+category;
}
</script>
...
$foto_upload->foto_folder = $_SERVER['DOCUMENT_ROOT'].$foldername."/images/event/photo/";
$foto_upload->thumb_folder = $_SERVER['DOCUMENT_ROOT'].$foldername."/images/event/thumb/";
...
if (isset($_POST['Submit']) && $_POST['Submit'] == "Upload") {
	...
	mysqli_query($mysqli1,"insert into `event` set `title`='$productname',`desc`='$productdesc',`date` = now(),`photourl`='".$foto_upload->the_file."'");
	echo"<table align=center width=500 style=background-color:gray;><tr style=background-color:lightgreen;font-family:arial;font-size:16px;font-weight:bold;><td>Confirmation</td></tr><tr style=font-family:verdana;color:white;font-weight:bold;><td>Success Inserted Event&nbsp;<a href=addevent.php style=color:blue;>BACK </a></td></tr><table>";
die();
	}
}
...
<?php
echo"<table align=center width=700 style=background-color:gray;>";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
echo"<tr bgcolor=lightgreen><td colspan=2 style=font-family:verdana;font-size:15px;text-align:center;font-weight:bold;>Add Event</td></tr>";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*echo"<tr>
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
echo"<tr><td style=font-family:arial;font-weight:bold;color:white; width=200>Title</td><td width=300><input style=width:500px; type=text name=productname></td></tr>";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
echo"<tr><td style=font-family:arial;font-weight:bold;color:white; width=200>Content</td width=300><td><textarea name=productdesc style=overflow:auto; cols=74 rows=20></textarea></td></tr>";
...
echo"<tr style=font-family:helvetica;font-size:14px;font-weight:bold;color:white;><td colspan=2>Click <a href=admin_viewevent.php style=color:red;text-decoration:none;font-family:verdana;>here</a> to view news</td></tr>";
echo"</table>	</form>";
echo"</body>";
?>