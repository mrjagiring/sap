...
if($_POST[submit]){
	mysqli_query($mysqli1,"INSERT INTO `menu_special` (`name`, `root`, `priority`) VALUES ('".$_POST[menuname]."','".$_POST[menuroot]."','".$_POST[menupriority]."')");
	echo"Success Input New Menu";
	die();
}
if($_GET[delete]){
	mysqli_query($mysqli1,"delete from `menu_special` where `id`='".$_GET[delete]."'");
}
