...
if (isset($_POST['Submit']) && $_POST['Submit'] == "Upload") {
	...
	if(strlen($namafoto)<=6){
	echo"<table align=center width=500 style=background-color:gray;><tr style=background-color:lightgreen;font-family:arial;font-size:16px;font-weight:bold;><td>Confirmation</td></tr><tr style=font-family:verdana;color:white;font-weight:bold;><td>Failed Upload Photo</td></tr><table>";
	die();
	}
	...
	mysqli_query($mysqli1,"update`data_product` set `url`='$namafoto' where `id`='$id'");
	echo"<table align=center width=500 style=background-color:gray;><tr style=background-color:lightgreen;font-family:arial;font-size:16px;font-weight:bold;><td>Confirmation</td></tr><tr style=font-family:verdana;color:white;font-weight:bold;><td>Success Inserted New Product&nbsp;<a href=admin_viewproduct.php?action=view target=admin style=color:blue; onclick=tutup();>View</a></td></tr><table>";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
echo"<tr bgcolor=lightgreen><td colspan=2 style=font-family:verdana;font-size:15px;text-align:center;font-weight:bold;>Change Product Picture</td></tr>";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
echo"<tr><td style=font-family:arial;font-weight:bold;color:white; width=200>Product Picture</td><td width=300>
